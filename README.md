...
To calculate the future states, we need to choose the number of time steps and elapsed duration. We experimented with different combinations of the time steps = (8, 10, 12) and elapsed time duration = (0.1, 0.12, 0.15). We find that the time steps = 10 and elapsed time duration = 0.15 is the most stable one.
